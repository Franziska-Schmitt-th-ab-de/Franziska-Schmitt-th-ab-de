...
**B.Sc. Medical Engineering & Data Science**   
  aktuell Zweitstudium der **Biologie** an der Universität Würzburg

Ich interessiere mich für datengetriebene Fragestellungen an der Schnittstelle von **Data Science, Machine Learning und Life Sciences**. In meinen Projekten habe ich bisher unter anderem mit Python, klassischem Machine Learning, Deep Learning und wissenschaftlicher Datenanalyse gearbeitet.

### Ausgewählte Projekte

- **[Axion MEA Analyzer](https://github.com/Franziska-Schmitt-th-ab-de/Axion_MEAanalyzer)**  
...
`Python` · `pandas` · `NumPy` · `scikit-learn` · `PyTorch` · `TensorFlow` · `Matplotlib` · `C++` · `R` · `Git` · `Docker` 

---

Aktuell suche ich eine **Werkstudentenstelle im Bereich Data Science / Analytics / Machine Learning**, gerne mit Bezug zu Life Sciences, Medizintechnik oder Forschung.
